...
### 1. Claude Code에서 플러그인 추가

```bash
claude mcp add --transport http karechat-api-converter https://github.com/hannie-init/karechat-api-converter
```

또는 Claude Code 실행 후 `/plugins` 명령으로 이 레포 URL을 직접 등록하세요.

```
/plugins add https://github.com/hannie-init/karechat-api-converter
```
